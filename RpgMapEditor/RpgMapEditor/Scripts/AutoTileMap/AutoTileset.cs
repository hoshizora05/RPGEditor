...
namespace CreativeSpore.RpgMapEditor
{
	...
	public class AutoTileset : ScriptableObject 
	{
        ...
        /// <summary>
        /// Size of the tile in pixels (RPG Maker MV 標準: 48×48)
        /// </summary>
        ...
        /// <summary>
        /// AtlasTexture を分割するスロットのピクセルサイズ
        /// （1 スロットあたり 32 タイル／行 × TileWidth）
        /// </summary>
        ...
        public void BuildAtlasSlotData()
        {
            ...
            if (size > 0)
            {
                if (AtlasSlots == null || AtlasSlots.Count == 0)
                {
                    ...
                    // MV compatibility: 48x48 tiles, 2x2 default setup
